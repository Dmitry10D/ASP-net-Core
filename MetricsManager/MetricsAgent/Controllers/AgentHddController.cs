...
namespace MetricsAgent.Controllers
{
    ...
    {
        private readonly ILogger<AgentHddController> _logger;

        public AgentHddController(ILogger<AgentHddController> logger)
        {
            _logger = logger;
            _logger.LogDebug(1, "NLog встроен в AgentHddController");
        }
